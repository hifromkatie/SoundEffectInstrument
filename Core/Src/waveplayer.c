...
extern __IO uint32_t RepeatState, PauseResumeStatus;
...
/**
  ...
  * @retval None
  */
void WavePlayerStart(const char* wavefilename)
{
  UINT bytesread = 0;
  char path[] = "0:/";
  ...
  {
    printf("Open wav directory\r\n");
    if(WaveRecStatus == 1)
    {
      printf("into recording section of playback");
